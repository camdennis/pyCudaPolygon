"""
fire_packing64_rounded.py — 64 bidisperse 32-gons (κ=3.7, ratio=1.4) at φ=0.8, FIRE + SHAKE.
Area-based (rounded) energy model.
...
OUT_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "rounded")
...
fig.savefig(os.path.join(OUT_DIR, "fire_packing64_rounded_before.png"), dpi=150, bbox_inches='tight')
plt.close(fig)
print("Saved fire_packing64_rounded_before.png")
...
def save_checkpoint(m, step, energy):
    ...
    img_path = os.path.join(OUT_DIR, f"fire_packing64_rounded_ckpt_{step:08d}.png")
    fig.savefig(img_path, dpi=150, bbox_inches='tight')
    plt.close(fig)
    ckpt_dir = os.path.join(OUT_DIR, f"fire_packing64_rounded_ckpt_{step:08d}")
...
fig.savefig(os.path.join(OUT_DIR, "fire_packing64_rounded_after.png"), dpi=150, bbox_inches='tight')
plt.close(fig)
print("Saved fire_packing64_rounded_after.png")
